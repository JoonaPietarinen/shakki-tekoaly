...
Mielestäni ohjelma on edistynyt hyvin. Solmujen määrä per sekuntti voisi olla parempi.

**Mitä opin tällä viikolla?**

Opin lisää optimoinneista, kuten killer moves -optimoinnista, sekä siitä, miten iteratiivinen syveneminen toimii käytännössä.
